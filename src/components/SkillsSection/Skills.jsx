...
import { SKILLS_DATA, QUICK_STATS } from './SkillsData';
    ...
    >
      ...
      <div className="flex justify-between items-center mb-2">
        <div className="flex items-center gap-3">
          ...
          <span
            className={`text-xs px-2 py-1 rounded-full ${skillLevel.color} bg-opacity-20`}
          >
            {skillLevel.text}
          </span>
        </div>
...
// ──────────────────────────────────────────────────────────────
export default function SkillsVisualization({ headingColor }) {
  ...
  return (
    <section className="max-w-6xl mx-auto py-16 px-4 lg:px-8">
      ...
      >
        <h2 className="text-4xl font-semibold mb-4" style={{color: "white"}}>Skills & Expertise</h2>
        <p
        ...
        >
          Interactive visualization of my technical skills, experience levels,
          and project involvement. Click any category to explore detailed
          proficiency.
        </p>
      </motion.div>
