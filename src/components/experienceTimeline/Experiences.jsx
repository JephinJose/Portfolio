...
import ProfessionalExperienceHeading from "./ProfessionalExperienceHeading";
...
// Main component
export default function Experience({ headingColor }) {

  const currentTheme = "minimal";
  ...
  return (
    <section className="max-w-6xl mx-auto py-12 px-4 lg:px-8">
      ...
      <div className="text-center mb-16">
        <h2 className="text-4xl font-semibold mb-4" style={{color: "white"}}>Professional Experience</h2>
        ...
        >
          From early AI experiments to designing end-to-end intelligent systems, this is my full-stack AI path. Open any experience to see the work behind it.
        </motion.p>
      </div>
